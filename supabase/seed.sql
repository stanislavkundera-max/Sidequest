...
values
  ...
  ('q-m-04', 'Digital sunset: no screens after 9 p.m. for three nights', 'E-ink readers OK; no video or social apps.', 'Pick three consecutive weeknights. After 9 p.m., no phone except calls, no TV or laptop. Read paper, stretch, or talk.', 'cat-relax', 'monthly', 'medium', 180, 'Which night was hardest, and what did you do instead?', 'text', true),
...
update public.quests set journey_intro = 'Three nights without screens after nine.', action_steps = $json$[{"id":"s1","title":"Pick three consecutive weeknights","estimateMinutes":5},{"id":"s2","title":"After 9 p.m. no video, social, or laptop","detail":"E-ink readers OK.","estimateMinutes":1},{"id":"s3","title":"On night 3, note what you did instead","estimateMinutes":10}]$json$::jsonb where id = 'q-m-04';
