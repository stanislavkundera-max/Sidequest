...
const styles = StyleSheet.create({
  ...
  headerLeaveBtnText: { color: Theme.danger, fontSize: 15, fontWeight: '600' },
  hintBlock: { marginTop: 12, gap: 8 },
  hintText: { fontSize: 13, lineHeight: 18, color: Theme.textMuted },
  ...
  cheerText: { fontSize: 14, fontWeight: '700', flex: 1 },
  stepCard: {
    backgroundColor: Theme.surface,
    borderRadius: 14,
    borderWidth: 1,
  ...
  stepTitle: { fontSize: 19, fontWeight: '700', color: Theme.text, marginBottom: 6 },
  stepDetail: { fontSize: 14, lineHeight: 20, color: Theme.textMuted, marginBottom: 10 },
  stepTipBlock: {
    marginBottom: 16,
    paddingLeft: 12,
    borderLeftWidth: 3,
  ...
  doneTitle: { fontSize: 19, fontWeight: '800', color: Theme.text, textAlign: 'center' },
  doneBody: { fontSize: 14, lineHeight: 20, color: Theme.textMuted, textAlign: 'center' },
  ...
  doneBackLinkText: { fontSize: 15, fontWeight: '600', color: Theme.accent },
});
