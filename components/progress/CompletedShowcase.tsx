...
const styles = StyleSheet.create({
  ...
  medalName: { fontSize: 13, fontWeight: '700', color: Theme.text },
  medalCount: { fontSize: 13, fontWeight: '800' },
  ...
  trophyRank: { fontSize: 9, fontWeight: '800', color: '#fff', marginTop: -1 },
  ...
  trophyTitle: { fontSize: 16, fontWeight: '700', color: Theme.text, lineHeight: 20, marginTop: 2 },
  trophyWhen: { fontSize: 12, fontWeight: '500', color: Theme.textMuted, marginTop: 3 },
  emptyCard: {
    marginHorizontal: 16,
    backgroundColor: Theme.surface,
    borderRadius: 16,
